...
class CPP14Visitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by CPP14Parser#yieldexpression.
    def visitYieldexpression(self, ctx:CPP14Parser.YieldexpressionContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by CPP14Parser#co_expression.
    def visitCo_expression(self, ctx:CPP14Parser.Co_expressionContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by CPP14Parser#co_statement.
    def visitCo_statement(self, ctx:CPP14Parser.Co_statementContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by CPP14Parser#co_compoundstatement.
    def visitCo_compoundstatement(self, ctx:CPP14Parser.Co_compoundstatementContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by CPP14Parser#co_statementseq.
    def visitCo_statementseq(self, ctx:CPP14Parser.Co_statementseqContext):
        return self.visitChildren(ctx)
    ...
    def visitTypename(self, ctx:CPP14Parser.TypenameContext):
        return self.visitChildren(ctx)
    ...
    def visitTypeid(self, ctx:CPP14Parser.TypeidContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by CPP14Parser#coroutinedefinition.
    def visitCoroutinedefinition(self, ctx:CPP14Parser.CoroutinedefinitionContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by CPP14Parser#coroutinebody.
    def visitCoroutinebody(self, ctx:CPP14Parser.CoroutinebodyContext):
        return self.visitChildren(ctx)
    ...
    def visitOperator(self, ctx:CPP14Parser.OperatorContext):
        return self.visitChildren(ctx)
